...
public class ScalarWebChannelMapper {
     ...
     */
    public ScalarWebChannelMapper(final Thing thing) {
        ...
        if (!ScalarWebConstants.THING_TYPE_SCALAR.equals(typeUID)) {
            for (final Channel chl : thing.getChannels()) {
     ...
     */
    public String getMappedChannelId(final String baseChannelId) {
     ...
     */
    public ChannelUID getMappedChannelId(final ChannelUID baseChannelUID) {
     ...
     * @return a non-null, non-empty channel id
     */
    public String getBaseChannelId(final String mappedChannelId) {
     ...
     * @return a non-null channel uid
     */
    public ChannelUID getBaseChannelId(final ChannelUID mappedChannelId) {
