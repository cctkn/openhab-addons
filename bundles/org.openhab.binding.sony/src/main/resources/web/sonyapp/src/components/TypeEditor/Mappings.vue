  ...
  <div class="parent">
    ...
    <table class="mappings">
      ...
      <tbody>
        <tr
          v-bind:key="index"
          v-for="(chl, index) in typeDefinition.channels"
          v-bind:class="{ even: index % 2 === 0, diff: chl.isMapped() }"
        >
        ...
        <div
          v-if="
            selectedChannel !== undefined &&
              selectedChannel.properties.length === 0
          "
        >
          Press &quot;Add&quot; above to add properties
        </div>
        ...
        <div class="content">
          ...
          >
            <tbody>
              <tr
                v-bind:key="index"
                v-for="(prop, index) in selectedChannel.properties"
              >
                <td class="label">
    ...
    <modal name="modal-state" @closed="modalClosed" :height="300">
      ...
      <div class="modal">
        <div
          v-if="
            selectedChannel !== undefined && selectedChannel.state.length === 0
          "
        >
          Press &quot;Add&quot; above to add state
        </div>
        ...
        <div class="content">
          ...
          >
            <tbody>
              <tr
                v-bind:key="index"
                v-for="(state, index) in selectedChannel.state"
              >
                <td class="label">
